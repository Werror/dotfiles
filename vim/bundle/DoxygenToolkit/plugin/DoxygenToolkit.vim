...
function! <SID>DoxygenCommentFunc()
  ...
  let s:spaceAtCursor = 0
 
  " Brief
  if( g:DoxygenToolkit_compactOneLineDoc =~ "yes" && l:doc.returns != "yes" && len( l:doc.params ) == 0 && len( l:doc.templates ) == 0 )
    ...
    let s:spaceAtCursor = 1
    let l:insertionMode = "s"
    if( s:interCommentTag != "" )
      exec "normal ".l:insertionMode.s:interCommentTag
      let l:insertionMode = "A"
    endif
    if( g:DoxygenToolkit_briefTag_pre != "" )
      exec "normal ".l:insertionMode.g:DoxygenToolkit_briefTag_pre
      let l:insertionMode = "A"
    endif
    if( l:doc.name != "None" )
      exec "normal ".l:insertionMode.l:doc.name." "
      let l:insertionMode = "A"
    endif
    if( g:DoxygenToolkit_briefTag_post != "" )
      exec "normal ".l:insertionMode.g:DoxygenToolkit_briefTag_post
      let l:insertionMode = "A"
    endif
